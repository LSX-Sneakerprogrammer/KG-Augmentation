...
class KGProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "similar_train.tsv")), "train", data_dir)
    ...
    def get_test_examples(self, data_dir):
      """See base class."""
      return self._create_examples(
          self._read_tsv(os.path.join(data_dir, "test_sample8.tsv")), "test", data_dir)
    ...
    def get_train_triples(self, data_dir):
        ...
        return self._read_tsv(os.path.join(data_dir, "similar_train.tsv"))
    ...
    def get_test_triples(self, data_dir):
        """Gets test triples."""
        return self._read_tsv(os.path.join(data_dir, "test_sample8.tsv"))
...
def main():
    ...
    parser.add_argument("--bert_model", default="/export2/liushixuan/models/pytorch_bert/", type=str, required=True,
